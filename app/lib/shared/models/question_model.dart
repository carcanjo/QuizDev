...
class QuestionModel {
  ...
  QuestionModel({ 
    ...
    required this.awnsers })  
      ...
      // atributo assert garante condição co contrutor para garantir a integridade di layout
      //  garanto a integridade da minha classe falando que ela tem 4 respostas
